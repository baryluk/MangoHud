    ...
    if [[ ! -f build/release/usr/lib/libMangoHud.so ]]; then
        ...
        case $DISTRO in
            ...
            *"buntu"|"Linux Mint"|"Debian GNU/Linux"|"Zorin OS"|"Pop!_OS"|"elementary OS"|"KDE neon")
                ...
                DEPS="{gcc,g++,gcc-multilib,g++-multilib,ninja-build,python3-pip,python3-setuptools,python3-wheel,pkg-config,mesa-common-dev,libx11-dev,libxnvctrl-dev,libdbus-1-dev,libnanopb-dev,nanopb,protobuf-compiler,python3-gi,python3-profobuf}"
                dep_install
